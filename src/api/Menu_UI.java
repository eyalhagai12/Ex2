...
public class Menu_UI implements ActionListener{
	...
	public Menu_UI(Graph_UI g) {
        ...
        edit.add(nodes); edit.add(edges);
        nodes.add(e1); edges.add(e2);
        nodes.add(e3); edges.add(e4);
        ...
        operations.add(o1); operations.add(o2);
        operations.add(o3); operations.add(o4);
        
        f1.addActionListener(this); f2.addActionListener(this);
        
        e1.addActionListener(this); e2.addActionListener(this);
        e3.addActionListener(this); e4.addActionListener(this);
        
        o1.addActionListener(this); o2.addActionListener(this);
        o3.addActionListener(this); o4.addActionListener(this);
        
        mb.add(file);
        mb.add(edit);
        mb.add(operations);  
	}
	public JMenuBar getMenuBar() {return mb;}
